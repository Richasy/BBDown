    ...
    static partial class BBDownUtil
    {
        public static async Task CheckUpdateAsync()
        {
            try
            {
                ...
                string redirctUrl = await GetWebLocationAsync("https://github.com/Richasy/BBDown/releases/latest");
                string latestVer = redirctUrl.Replace("https://github.com/Richasy/BBDown/releases/tag/", "");
